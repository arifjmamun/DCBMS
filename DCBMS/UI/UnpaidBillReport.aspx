                        ...
                        <div class="box-body">
                            ...
                            <asp:GridView ID="unpaidBillReportGridView" runat="server" CssClass="table table-striped" ClientIDMode="Static" GridLines="None" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="billNoColumn" HeaderText="Bill No." />
                                    <asp:BoundField DataField="contactNoColumn" HeaderText="Contact No." />
                                    <asp:BoundField DataField="billAmountColumn" HeaderText="Bill Amount" />
                                </Columns>
